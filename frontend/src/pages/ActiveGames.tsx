        ...
        <div className="relative z-10 max-w-[90vw] mx-auto px-4 w-full">
          ...
          {loading && games.length === 0 ? (
            <div className="flex flex-col items-center justify-center py-20 gap-4">
              ...
              <p className="text-yellow-500/40 uppercase tracking-widest text-xs font-bold">
                Scanning for tables...
              </p>
            </div>
          ) : games.length === 0 ? (
            <div className="flex items-center justify-center py-20">
              <div className="bg-[#0a0a0a]/80 backdrop-blur-xl border border-yellow-500/20 rounded-3xl p-12 text-center shadow-[0_0_50px_rgba(0,0,0,0.6)] max-w-lg w-full">
                ...
                <p className="text-yellow-500/40 mb-8 max-w-md mx-auto text-sm">
                  There are currently no tables open. Be the first to start the
                  action!
                </p>
                <button
              ...
              {games.map((game) => (
                ...
                >
                  <div className="flex justify-between items-start mb-4">
                    <div>
                      <h3 className="text-lg font-bold text-yellow-100 mb-0.5 group-hover:text-yellow-400 transition-colors truncate max-w-[180px]">
                        {game.name}
                      </h3>
                      <p className="text-yellow-500/40 text-[10px] font-bold uppercase tracking-wider">
                  ...
                  <div className="space-y-2 mb-4 flex-1">
                    <div className="flex items-center justify-between p-2.5 bg-black/40 rounded-xl border border-yellow-500/10">
                      <span className="text-yellow-500/60 text-[10px] font-bold uppercase tracking-wider">
                        Players
                      </span>
