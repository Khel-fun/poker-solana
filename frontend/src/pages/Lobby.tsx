    ...
    <>
      ...
      <div className="min-h-screen pt-20 bg-[url('/bg.png')] bg-cover bg-center relative">
        ...
        <div className="px-16 mx-auto">
          ...
          <div className="bg-[url('/card-bg.jpg')] h-[85vh] backdrop-blur-sm rounded-2xl p-8 mb-6 border border-red-800/50 shadow-2xl flex flex-col justify-between">
            <div className="flex flex-col gap-5">
              <h1 className="text-4xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-yellow-200 to-yellow-500 mb-4 capitalize">
                {gameState.name}
              </h1>
              ...
              <div className="flex flex-wrap gap-4 mb-6 px-4">
                {gameState.players.map((player) => (
                  <div
                    ...
                    style={{
                      boxShadow:
                        "0 0 30px rgba(0,0,0,0.5), inset 0 0 0 3px rgba(234,179,8,0.3), inset 0 0 0 6px rgba(234,179,8,0.6)",
                    }}
                  >
                    ...
                    <div className="relative pt-6">
                      ...
                      <div className="text-center pb-4 border-b-2 border-[#b8751e]">
                        ...
                        <div className="flex gap-2 justify-center items-center">
                          ...
                          {player.id === playerId && (
                            <span className="inline-block text-xs bg-yellow-500 text-black px-3 py-1 rounded-full font-bold h-fit">
                              YOU
                            </span>
                          )}
                        </div>
